...
export { buildBackendDependencyGraph, detectCircularDependencies } from './graph-builder';
export { detectCircularDependencies as detectBackendCircularDependencies } from './graph-builder';
